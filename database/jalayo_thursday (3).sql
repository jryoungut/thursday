...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 19, 2015 at 06:23 PM
...
INSERT INTO `apparatus` (`ID`, `Apparatus`, `FleetNum`, `StationID`, `TireCnt`, `MotorTracking`, `NextServiceDue`, `DryPrime`, `AirTank`, `Active`, `ModifiedDate`) VALUES
...
--
-- Table structure for table `majorgroups`
--

CREATE TABLE IF NOT EXISTS `majorgroups` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` text NOT NULL,
...
--
-- Dumping data for table `majorgroups`
--

INSERT INTO `majorgroups` (`id`, `name`, `active`, `modifieddate`) VALUES
(1, 'Battalion 2', 1, '0000-00-00 00:00:00');
...
INSERT INTO `settings` (`id`, `name`, `value`, `active`, `modifieddate`) VALUES
(1, 'Major Group Name', 'Battalions', 1, '2015-01-11 03:41:09');
